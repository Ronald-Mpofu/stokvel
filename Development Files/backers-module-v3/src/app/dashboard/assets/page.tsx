...
// ── Asset Detail ───────────────────────────────────────────────
function AssetDetail({ asset, members, onBack, onSuccess, onCosting, onQueue, onBackers }: any) {
...
export default function AssetsPage() {
  const [view, setView]         = useState<'list'|'create'|'detail'|'costing'|'queue'|'backers'>('list')
