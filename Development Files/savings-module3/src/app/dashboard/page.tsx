...
const NAV_ITEMS = [
  ...
  { id: 'savings',       icon: '💰', label: 'Savings Pools'  },
    ...
    <div style={{ display: 'flex', height: '100vh', fontFamily: 'system-ui, sans-serif', background: '#F8FAFC' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, overflow: 'auto', padding: '24px' }}>
          ...
          {active === 'invitations' && <InvitationsPage />}
          ...
          {active === 'portal' && (
            <div style={{ textAlign:'center', padding:'60px 40px' }}>
              ...
              <h2 style={{ fontSize:'18px', fontWeight:'700', color:'#0D2137', margin:'0 0 10px' }}>Member Portal</h2>
              ...
              <a href="/portal" target="_blank" rel="noopener noreferrer"
                style={{ display:'inline-block', padding:'12px 28px', background:'linear-gradient(135deg,#0D2137,#0F6E56)', color:'white', textDecoration:'none', borderRadius:'10px', fontSize:'14px', fontWeight:'600' }}>
                🚀 Open Member Portal →
              </a>
