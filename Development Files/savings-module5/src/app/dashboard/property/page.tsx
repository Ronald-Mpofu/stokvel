              ...
              {['FUNDING','ACQUIRED'].includes(prop.status) && (
                <div style={{background:'#F0FDF4',borderRadius:'12px',padding:'16px',border:'1px solid #BBF7D0'}}>
                  ...
                  <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr 1fr',gap:'8px',alignItems:'end'}}>
                    <div>
                      <label style={{display:'block',fontSize:'11px',fontWeight:'600',color:'#374151',marginBottom:'4px',textTransform:'uppercase' as any}}>Member</label>
                      <select value={contributeForm.userId} onChange={e=>setContributeForm(f=>({...f,userId:e.target.value}))}
                        style={{width:'100%',padding:'8px 10px',border:'1.5px solid #E2E8F0',borderRadius:'6px',fontSize:'12px',outline:'none',background:'white',boxSizing:'border-box' as any}}>
                        <option value="">Select...</option>
                        {members.filter((m:any)=>m.groupId===prop.groupId).map((m:any)=><option key={m.userId} value={m.userId}>{m.fullName}</option>)}
                      </select>
                    </div>
                    <div>
                      <label style={{display:'block',fontSize:'11px',fontWeight:'600',color:'#374151',marginBottom:'4px',textTransform:'uppercase' as any}}>Amount ($)</label>
                      <input type="number" step="0.01" value={contributeForm.amount} onChange={e=>setContributeForm(f=>({...f,amount:e.target.value}))} placeholder="0.00"
                        style={{width:'100%',padding:'8px 10px',border:'1.5px solid #E2E8F0',borderRadius:'6px',fontSize:'13px',fontWeight:'600',outline:'none',boxSizing:'border-box' as any}}/>
                    </div>
                    <div>
                      <label style={{display:'block',fontSize:'11px',fontWeight:'600',color:'#374151',marginBottom:'4px',textTransform:'uppercase' as any}}>Method</label>
              ...
              {['RENTING','ACQUIRED'].includes(prop.status) && (
                <div style={{background:'#F0FDF4',borderRadius:'12px',padding:'16px',border:'1px solid #BBF7D0'}}>
                  ...
                  <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:'10px',marginBottom:'10px'}}>
                    <div>
                      <label style={{display:'block',fontSize:'11px',fontWeight:'600',color:'#374151',marginBottom:'4px',textTransform:'uppercase' as any}}>Period (YYYY-MM) *</label>
                      <input type="month" value={rentalForm.period} onChange={e=>setRentalForm(f=>({...f,period:e.target.value}))}
                        style={{width:'100%',padding:'8px 10px',border:'1.5px solid #E2E8F0',borderRadius:'6px',fontSize:'12px',outline:'none',boxSizing:'border-box' as any}}/>
                    </div>
                    <div>
                      <label style={{display:'block',fontSize:'11px',fontWeight:'600',color:'#374151',marginBottom:'4px',textTransform:'uppercase' as any}}>Gross Rental ($) *</label>
              ...
              <div style={{background:'#F0FDF4',borderRadius:'12px',padding:'16px',border:'1px solid #BBF7D0'}}>
                ...
                <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr 1fr',gap:'8px',alignItems:'end'}}>
                  {[['valuationDate','Date','date',''],['marketValue','Market Value ($)','number','0'],['valuedBy','Valued By','text','Estate agent name'],['method','Method','text','bank_valuation']].map(([k,l,t,p])=>(
                    <div key={k}>
                      <label style={{display:'block',fontSize:'10px',fontWeight:'600',color:'#374151',marginBottom:'4px',textTransform:'uppercase' as any}}>{l}</label>
...
function VersionBadge() {
  return (
    <div style={{ position:'fixed', bottom:'12px', right:'12px', background:'rgba(13,33,55,0.85)', color:'white', fontSize:'10px', padding:'4px 10px', borderRadius:'999px', zIndex:9998, fontFamily:'monospace', backdropFilter:'blur(4px)', display:'flex', alignItems:'center', gap:'6px' }}>
      ...
      <span style={{ opacity:0.8 }}>🏠 Property Investments</span>
      <span style={{ background:'#0F6E56', padding:'1px 6px', borderRadius:'999px', fontWeight:'700' }}>v1.1</span>
    </div>
  )
}
