    ...
    <div style={{ display:'flex', flexDirection:'column', gap:'16px' }}>
      ...
      {detailTab==='members' && (
        <div style={{ background:'white', borderRadius:'12px', border:'1px solid #E2E8F0', padding:'20px' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'16px' }}>
            ...
            <button onClick={() => setShowInviteModal(true)} style={{ padding:'7px 14px', background:TEAL, color:'white', border:'none', borderRadius:'8px', fontSize:'12px', cursor:'pointer', fontWeight:'500' }}>+ Invite</button>
          </div>
      ...
      {showInviteModal && (
        <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.5)', display:'flex', alignItems:'center', justifyContent:'center', zIndex:1000 }}>
          <div style={{ background:'white', borderRadius:'16px', padding:'28px', width:'400px', boxShadow:'0 25px 50px rgba(0,0,0,0.2)' }}>
            ...
            <Select label="Role" value="MEMBER" onChange={()=>{}} options={[{value:'MEMBER',label:'Member'},{value:'TREASURER',label:'Treasurer'}]} />
            <div style={{ display:'flex', gap:'10px', marginTop:'8px' }}>
              ...
              <button onClick={() => { setShowInviteModal(false); showToast('Invitation sent!') }} style={{ flex:1, padding:'10px', background:TEAL, color:'white', border:'none', borderRadius:'8px', fontSize:'13px', fontWeight:'600', cursor:'pointer' }}>Send Invite</button>
            </div>
          </div>
        </div>
      )}
