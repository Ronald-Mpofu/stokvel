      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          ...
          {asset.allowOutsiders && (
            <button onClick={() => onBackers && onBackers()} style={{ padding: '8px 14px', background: '#F0FDF4', color: '#166534', border: '1px solid #86EFAC', borderRadius: '8px', fontSize: '12px', cursor: 'pointer', fontWeight: '600' }}>🌐 Backers</button>
          )}
              ...
              <div key={a.id} style={{ background: 'white', borderRadius: '12px', border: `1px solid ${isRR ? '#C4B5FD' : '#E2E8F0'}`, overflow: 'hidden' }}>
                ...
                <div style={{ padding: '14px 16px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '6px' }}>
                    ...
                    {a.allowOutsiders && (
                      <button onClick={() => { setSelected(a); setView('backers') }} title="Outside Backers"
                        style={{ padding: '8px 10px', background: '#F0FDF4', color: '#166534', border: 'none', borderRadius: '8px', fontSize: '12px', cursor: 'pointer' }}>🌐</button>
                    )}
