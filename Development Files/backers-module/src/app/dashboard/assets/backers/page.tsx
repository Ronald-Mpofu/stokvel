...
export default function BackersPanel({ asset, onClose }: { asset: any; onClose: () => void }) {
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:'16px' }}>
      ...
      {/* Outsiders disabled notice */}
      {!asset.allowOutsiders && (
        <div style={{ background:'#FEF9C3', border:'1px solid #FCD34D', borderRadius:'12px', padding:'16px 20px', fontSize:'13px', color:'#854D0E', display:'flex', alignItems:'center', gap:'12px' }}>
          <span style={{ fontSize:'24px' }}>⚠️</span>
          <div>
            <div style={{ fontWeight:'600', marginBottom:'4px' }}>Outside contributors are disabled for this campaign</div>
            <div style={{ fontSize:'12px' }}>To enable outside backers, edit the campaign settings and toggle "Allow outside contributors" on.</div>
          </div>
        </div>
      )}
