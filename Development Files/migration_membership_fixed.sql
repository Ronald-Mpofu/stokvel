...
DO $$ BEGIN
  CREATE TYPE "PaymentMethod" AS ENUM ('CARD', 'ECOCASH', 'BANK_TRANSFER', 'CASH');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;
...
-- Uses PaymentMethod enum values expected by the current app: CARD, ECOCASH, BANK_TRANSFER, CASH.
