          ...
          {step===3&&<>
            ...
            {form.groupId&&groupMembers.length>0&&<>
              <div style={{display:'flex',justifyContent:'space-between',marginBottom:'8px',fontSize:'12px'}}>
                <span style={{color:'#64748B'}}>{form.memberIds.length} of {groupMembers.length} selected</span>
                <button type="button" onClick={()=>set('memberIds')(form.memberIds.length===groupMembers.length?[]:groupMembers.map((m:any)=>m.userId))}
              ...
              <div style={{display:'flex',flexDirection:'column',gap:'6px'}}>
                {groupMembers.map((m:any)=>{
                  ...
                  return <div key={m.userId} onClick={()=>set('memberIds')(sel?form.memberIds.filter((id:string)=>id!==m.userId):[...form.memberIds,m.userId])}
