...
<body style="margin:0;padding:0;background:#F8FAFC;font-family:system-ui,sans-serif">
  <div style="max-width:560px;margin:40px auto;background:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08)">
    ...
    <div style="background:linear-gradient(135deg,#0D2137,#0F6E56);padding:32px 40px;text-align:center">
      ...
      <p style="color:rgba(255,255,255,0.7);font-size:13px;margin:6px 0 0">Stokvel Platform</p>
    </div>
    ...
    <div style="padding:32px 40px">
      ...
      <p style="font-size:14px;color:#475569;line-height:1.6;margin:0 0 24px">
        ...
        on the Stokvel Platform and has listed you as a guarantor. Your approval is required to proceed.
      </p>
