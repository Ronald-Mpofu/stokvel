...
export async function GET(req: NextRequest) {
  try {
    ...
    console.error('GET /api/savings/contributions error:', e)
...
export async function POST(req: NextRequest) {
  try {
    ...
    await exec(
      `UPDATE "SavingsContribution" SET "amountPaid"=$1, status=$2::"SavingsContributionStatus", "paidAt"=$3, "paymentMethod"=$4, "paymentRef"=$5, "updatedAt"=NOW() WHERE id=$6`,
    ...
    await exec(
      `INSERT INTO "Transaction" (id,type,status,amount,currency,description,reference,"paymentMethod","userId","createdAt")
       VALUES ($1,'CONTRIBUTION'::"TransactionType",'COMPLETED'::"TransactionStatus",$2,$3::"CurrencyCode",$4,$5,$6::"PaymentMethod",$7,NOW())`,
